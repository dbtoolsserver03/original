...
package com.ph.share.share.quartz.examples.example11;
...
public class SimpleJob implements Job {
  ...
  public void execute(JobExecutionContext context) throws JobExecutionException {
    ...
    System.out.println("Executing job: " + jobKey + " executing at " + DFUtil.format(new Date()));
    ...
    System.out.println("Finished Executing job: " + jobKey + " at " + DFUtil.format(new Date()));
  }
